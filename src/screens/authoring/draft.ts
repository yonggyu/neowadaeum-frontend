 ...
 * "STEP 3 / 5 · 캐릭터" 이므로 그 자리를 채울 값이 필요하고, 와이어프레임 셋이 다섯을 모두
 * 적어 두었다: 기본 정보(3d) · 세계관(3d) · 캐릭터(3d) · 챕터 & 엔딩(3e) · 미리보기(3e).
 */
export const STEP_LABELS = ['기본 정보', '세계관', '캐릭터', '챕터 & 엔딩', '미리보기'] as const
